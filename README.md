...
Theoretically there will be the least errors if we use the idea that the train moving equation contains 3 states:acceleration, constant speed and deceleration. If so, we could figure out the coordinates of each log point.
...
We also could apply “mean” and k-means regression methods of filtration to avoid a noise.
